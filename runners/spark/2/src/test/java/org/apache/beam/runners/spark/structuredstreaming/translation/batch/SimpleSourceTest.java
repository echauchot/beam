...
import org.apache.beam.runners.spark.structuredstreaming.translation.batch.DatasetSourceBatchImpl;
...
public class SimpleSourceTest implements Serializable {
  ...
  public void testSerialization() throws IOException {
    ...
    DataSourceReader objectToTest =
        new DatasetSourceBatchImpl().createReader(new DataSourceOptions(dataSourceOptions));
